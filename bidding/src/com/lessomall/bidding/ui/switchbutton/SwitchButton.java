package com.lessomall.bidding.ui.switchbutton;
...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setInsetBounds(ta.getDimensionPixelSize(R.styleable.SwitchButton_insetLeft, 0),
				ta.getDimensionPixelSize(R.styleable.SwitchButton_insetTop, 0), ta.getDimensionPixelSize(R.styleable.SwitchButton_insetRight, 0),
	...
	protected void onDraw(Canvas canvas) {
		...
		if (useGeneralDisableEffect) {
			canvas.saveLayerAlpha(mSaveLayerZone, 255 / 2, Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG | Canvas.HAS_ALPHA_LAYER_SAVE_FLAG
